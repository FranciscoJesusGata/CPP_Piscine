...
/*   Updated: 2022/02/10 21:03:11 by fgata-va         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(void): _hitpoints(0), _energypoints(10), _attackdamage(0) {

	std::cout << "New ClapTrap created" << std::endl;
	return ;
}

ClapTrap::ClapTrap(std::string name): _name(name), _hitpoints(0), _energypoints(10), _attackdamage(0) {
